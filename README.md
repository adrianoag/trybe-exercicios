...
##### Seção 1: [Unix, Shell e Git](https://github.com/adrianoag/trybe-exercicios/tree/main/fundamentos/secao-01-unix-shell-e-git)
...
##### Seção 4: [Javascript: DOM, Eventos e Web Storage](https://github.com/adrianoag/trybe-exercicios/tree/main/fundamentos/secao-04-javascript-dom-eventos-e-web-storage)
...
##### Seção 5: [HTML e CSS: Forms, Flexbox e Responsivo](https://github.com/adrianoag/trybe-exercicios/tree/main/fundamentos/secao-05-html-e-css-forms-flexbox-e-reponsivo)
- [ ] 5.1 - HTML & CSS - Forms
...
##### Seção 6: [Introdução à JavaScript ES6 e Testes Unitários](https://github.com/adrianoag/trybe-exercicios/tree/main/fundamentos/secao-06-introducao-a-javascript-es6-e-testes-unitarios)
- [ ] 6.1 - Fluxo de esceções e manipulação de objetos
- [ ] 6.2 - Primeiros passos em Jest
- [ ] 6.3 - Matchers e cobertura de código
- [ ] 6.4 - Projeto - Javascript Testes Unitários

##### Seção 7: [Higher Order Functions do JavaScript ES6](https://github.com/adrianoag/trybe-exercicios/tree/main/fundamentos/secao-07-higher-order-funcions-do-javascript-es6)
